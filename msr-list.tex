...
Molten salt reactors, or MSRs, are a hopeful candidate for the next line of commerical nuclear reactors.  However, there is a lack of experiental data and real-world experience compared to the light-water reactors that make up much of the world's current fleet.***say more words here later***
...
Spectrum & value \\
\hline
Core Inlet Temperature & value \\
\hline
Core Outlet Temperature & value\\
\hline
Pressure & value \\
\hline
\end{tabular}
...
\begin{itemize}
\item Heat generation of 10 MWth
\item Single-region
